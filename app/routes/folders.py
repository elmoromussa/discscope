"""GET /folders — Llistat folder_stats amb filtre per disc i paginació."""
import sqlite3
...
def folders_page(
    ...
    if sort not in queries.FOLDERS_LIST_SORT_COLUMNS:
        sort = None
    ...
    if submitted:
        rows, total = queries.get_folders_list(
    ...
    sort_urls = {col: _sort_url(col) for col in queries.FOLDERS_LIST_SORT_COLUMNS}
